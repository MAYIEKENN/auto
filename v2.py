...
API_URL = "https://myluckynet.com/v2/atom/index.php?endpoint=admin_view"
...
numbers_url = 'https://myluckynet.com/v2/phone/'
...
async def refresh_phone_number(session, phone):
    refresh_url = f'https://myluckynet.com/v2/refresh/?phone={phone}'
